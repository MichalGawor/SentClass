...
class Batcher(TimeseriesGenerator):
    """
    Class for batching data
    Args:
        x ([string]): list of senteces
        y ([string]): list of labels
        batch_size (int): size of batch on every iteration
        preprocess (function): preprocessor transformation function to be applied on batch on every iteration
    """
